...
namespace ConsoleTestProject
{
    public class ConsoleTesting
    {
        ...
        public void CheckWordListConstructor()
        {
            ...
            Assert.Equal("AAA", wordlistinstance.wordList[12]);
        }
        [Fact]
        public void CheckWordListRemovedWrongWords()
        {
            WordListGenerator wordlistinstance = new WordListGenerator(_listofwordsfromwordfile, 4);
            wordlistinstance.RemoveWrongLength();
            Assert.Equal("Abel", wordlistinstance.wordList[13]);
        }
